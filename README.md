...
Extreme Networks hardware monitoring extension for Zabbix plugin configuration
------------------------------------------------------------------------------
...
3. Enable SNMP trap daemon for Zabbix plugin on the Settings tab of the Fuel
   web UI.
4. Enable Extreme Networks hardware monitoring extension for Zabbix plugin
   on the Settings tab of the Fuel web UI.
5. Optionally, fill in values in the form:
   * Extreme Networks hardware to monitor - comma separated NAME:IP values
     for each Extreme Networks hardware from which SNMP traps will be send
